...
class PyramidKVPipelineConfig:
    ...
    pyramidkv_label_coherent_motion_max_pair_age_map: Optional[dict] = None
    pyramidkv_label_coherent_motion_stale_refresh_map: Optional[dict] = None
    pyramidkv_label_coherent_motion_state_match_map: Optional[dict] = None
    pyramidkv_label_coherent_motion_state_min_similarity_map: Optional[dict] = None
    pyramidkv_label_coherent_motion_state_min_direction_similarity_map: Optional[dict] = None
    pyramidkv_label_coherent_motion_state_max_read_age_map: Optional[dict] = None
    ...
    pyramidkv_label_coherent_motion_state_direction_tie_margin_map: Optional[dict] = None
    pyramidkv_label_coherent_motion_state_stale_tie_age_map: Optional[dict] = None
    pyramidkv_label_coherent_motion_state_motion_signature_mode_map: Optional[dict] = None
    pyramidkv_label_semantic_retrieval_capacity_map: Optional[dict] = None
    pyramidkv_label_semantic_retrieval_archive_capacity_map: Optional[dict] = None
    pyramidkv_label_semantic_retrieval_max_age_map: Optional[dict] = None
    pyramidkv_semantic_retrieval_min_similarity: float = -0.25
    pyramidkv_semantic_retrieval_min_margin: float = 0.0
    ...
    def from_args(cls, args, frame_seq_length: int = 1560) -> "PyramidKVPipelineConfig":
        ...
        return cls(
            ...
            pyramidkv_label_semantic_landmark_capacity_map=getattr(
                args,
            ...
            pyramidkv_label_coherent_motion_max_pair_age_map=getattr(
                args,
                "pyramidkv_label_coherent_motion_max_pair_age_map",
                None,
            ),
            pyramidkv_label_coherent_motion_stale_refresh_map=getattr(
                args,
                "pyramidkv_label_coherent_motion_stale_refresh_map",
                None,
            ),
            pyramidkv_label_coherent_motion_state_match_map=getattr(
                args,
                "pyramidkv_label_coherent_motion_state_match_map",
                None,
            ),
            pyramidkv_label_coherent_motion_state_min_similarity_map=getattr(
                args,
                "pyramidkv_label_coherent_motion_state_min_similarity_map",
                None,
            ),
            pyramidkv_label_coherent_motion_state_min_direction_similarity_map=getattr(
                args,
                "pyramidkv_label_coherent_motion_state_min_direction_similarity_map",
                None,
            ),
            pyramidkv_label_coherent_motion_state_max_read_age_map=getattr(
                args,
                "pyramidkv_label_coherent_motion_state_max_read_age_map",
                None,
            ),
            pyramidkv_label_coherent_motion_state_archive_capacity_map=getattr(
                args,
                "pyramidkv_label_coherent_motion_state_archive_capacity_map",
                None,
            ),
            pyramidkv_label_coherent_motion_state_selection_order_map=getattr(
                args,
            ...
            pyramidkv_label_coherent_motion_state_direction_tie_margin_map=getattr(
                args,
                "pyramidkv_label_coherent_motion_state_direction_tie_margin_map",
                None,
            ),
            pyramidkv_label_coherent_motion_state_stale_tie_age_map=getattr(
                args,
                "pyramidkv_label_coherent_motion_state_stale_tie_age_map",
                None,
            ),
            pyramidkv_label_coherent_motion_state_motion_signature_mode_map=getattr(
                args,
            ...
            pyramidkv_label_semantic_retrieval_archive_capacity_map=getattr(
                args,
                "pyramidkv_label_semantic_retrieval_archive_capacity_map",
                None,
            ),
            ...
            pyramidkv_semantic_retrieval_min_similarity=float(
                getattr(
                    args,
            ...
            pyramidkv_semantic_retrieval_min_margin=float(
                getattr(
                    args,
            ...
            pyramidkv_semantic_retrieval_abstain=bool(
                getattr(
                    args,
