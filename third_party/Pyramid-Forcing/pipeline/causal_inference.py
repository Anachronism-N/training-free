...
class CausalInferencePipeline(torch.nn.Module):
    ...
    def __init__(
        ...
        self._parity_trace_video_index = 0
        self.args = args
    ...
    def inference(
        ...
        parity_trace = None
        parity_video_index = int(self._parity_trace_video_index)
        self._parity_trace_video_index += 1
        if os.environ.get("SF_PARITY_TRACE_DIR"):
            ...
            parity_trace.set_context(
                video_index=parity_video_index,
                runtime=os.environ.get("SF_PARITY_RUN_KIND", "pf_runtime"),
            )
        ...
        for block_index, current_num_frames in enumerate(all_num_frames, start=1):
            ...
            for index, current_timestep in enumerate(self.denoising_step_list):
                ...
                if parity_trace is not None:
                    parity_trace.record_event(
                        "flow_prediction", {"flow": flow_cond}, keep_full=True
                    )
                    parity_trace.record_event(
                        "denoised_prediction",
                        {"x0": denoised_pred},
            ...
            clean_flow_pred, _ = self.generator(
        ...
        if self.use_pyramidkv:
            ...
            if hc.use_adaptive_pyramidkv and hc.pyramidkv_policy_csv_path:
                compositions = build_compositions(
                    ...
                    label_coherent_motion_state_match_map=hc.pyramidkv_label_coherent_motion_state_match_map,
                    label_coherent_motion_state_min_similarity_map=hc.pyramidkv_label_coherent_motion_state_min_similarity_map,
                    label_coherent_motion_state_min_direction_similarity_map=hc.pyramidkv_label_coherent_motion_state_min_direction_similarity_map,
                    label_coherent_motion_state_max_read_age_map=hc.pyramidkv_label_coherent_motion_state_max_read_age_map,
                    label_coherent_motion_state_archive_capacity_map=hc.pyramidkv_label_coherent_motion_state_archive_capacity_map,
                    label_coherent_motion_state_selection_order_map=hc.pyramidkv_label_coherent_motion_state_selection_order_map,
                    label_coherent_motion_state_recency_weight_map=hc.pyramidkv_label_coherent_motion_state_recency_weight_map,
                    label_coherent_motion_state_similarity_weight_map=hc.pyramidkv_label_coherent_motion_state_similarity_weight_map,
                    label_coherent_motion_state_fallback_to_newest_map=hc.pyramidkv_label_coherent_motion_state_fallback_to_newest_map,
                    label_coherent_motion_state_direction_tie_margin_map=hc.pyramidkv_label_coherent_motion_state_direction_tie_margin_map,
                    label_coherent_motion_state_stale_tie_age_map=hc.pyramidkv_label_coherent_motion_state_stale_tie_age_map,
                    label_coherent_motion_state_motion_signature_mode_map=hc.pyramidkv_label_coherent_motion_state_motion_signature_mode_map,
                    label_semantic_retrieval_capacity_map=hc.pyramidkv_label_semantic_retrieval_capacity_map,
                    label_semantic_retrieval_archive_capacity_map=hc.pyramidkv_label_semantic_retrieval_archive_capacity_map,
                    ...
                    label_temporal_profile_anchor_capacity_map=hc.pyramidkv_label_temporal_profile_anchor_capacity_map,
            ...
            self.kv_cache1 = [
                (
                    AdaptiveKVCache(
                        ...
                        cache_compat_profile_enabled=hc.pyramidkv_cache_compat_profile_enabled,
                        cache_compat_profile_recent_frames=hc.pyramidkv_cache_compat_profile_recent_frames,
