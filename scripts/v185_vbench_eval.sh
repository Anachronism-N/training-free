...
COMPARISON_MANIFEST="$ROOT/runs/v185_pf_baseline/vbench_comparison/comparison_manifest.json"
VIDEOS_PATH="$ROOT/runs/v185_pf_baseline/vbench_comparison/published/pf_native"
FULL_JSON_DIR="$VBENCH_ROOT/vbench2_beta_long/VBench_full_info.json"
OUTPUT_BASE="$ROOT/runs/v185_pf_baseline/metrics/vbench_long_parts/pf_native"
