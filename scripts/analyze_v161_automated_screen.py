#!/usr/bin/env python3
"""Build the v161 diagnostic screen using the frozen v160 feature logic."""
...
def configure() -> None:
    base.EXPERIMENT = "v161_automated_diagnostic_screen"
    base.SOURCE_EXPERIMENT = "v161_state_matched_motion_moviebench16"
    base.REPORT_TITLE = "v161 Automated Diagnostic Screen"
    base.LOG_PREFIX = "v161-screen"
