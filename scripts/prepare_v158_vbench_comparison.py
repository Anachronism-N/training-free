#!/usr/bin/env python3
"""Materialize prompt-correct VBench inputs for v158."""
...
COMPARISON_EXPERIMENT = "v158_interleaved_budget_vbench16"
PROMPT_COUNT = 16
METHODS = (
    "sf_native",
    "ours_interleaved6_reservoir4",
    "ours_interleaved8_reservoir4",
