#!/usr/bin/env python3
"""Materialize prompt-correct VBench inputs for v172."""
...
from run_v172_relative_depth_moviebench16 import EXPECTED_METHOD_KEYS


EXPERIMENT = "v172_relative_depth_moviebench16"
COMPARISON_EXPERIMENT = "v172_relative_depth_vbench16"
PROMPT_COUNT = 16
METHODS = EXPECTED_METHOD_KEYS
