#!/usr/bin/env python3
"""Create a deterministic, method-blind review package for v158."""
...
from prepare_v158_vbench_comparison import METHODS, PROMPT_COUNT
...
def main() -> None:
    ...
    if (
        ...
        or published.get("experiment") != "v158_interleaved_budget_moviebench16"
        ...
        raise SystemExit("v158 manifests violate the blind-review contract")
    ...
    base.write_frozen(
        output_root / "reviewer" / "v158_review_sheet.csv",
    ...
    base.write_frozen(
        output_root / "private" / "v158_blind_key.json",
        base.canonical_json(key),
    )
    print(
        f"[v158-blind] PASS videos={len(key_rows)} links={link_modes} "
