#!/usr/bin/env python3
"""Re-analyze frozen v165 VBench results without duplicate metric weighting."""
...
from prepare_v165_vbench_comparison import METHODS, PROMPT_COUNT
from v165_decision_contract import DIRECTION_MATCH, PRIMARY, SF
...
def parse_args() -> argparse.Namespace:
    ...
    run_root = root / "runs" / "v165_direction_stale_tie_moviebench16" / "full8"
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=run_root / "analysis" / "v165_corrected_metrics.json",
    )
...
def write_markdown(path: Path, report: dict) -> None:
    lines = [
        "# v165 Corrected VBench Metric Addendum",
        "",
        "This addendum preserves the frozen v165 decision and corrects only",
        "the interpretation of duplicated VBench dimensions.",
        "",
...
def main() -> None:
    ...
    raw, scales = base.load_vbench_prompt_rows(
    ...
    report = {
        "version": 1,
        "experiment": "v165_corrected_metric_addendum",
