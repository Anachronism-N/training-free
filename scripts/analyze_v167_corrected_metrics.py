#!/usr/bin/env python3
"""Analyze v167 VBench results without duplicate metric weighting."""
...
from prepare_v167_vbench_comparison import DIMENSIONS, METHODS, PROMPT_COUNT
...
def parse_args() -> argparse.Namespace:
    ...
    run_root = root / "runs" / "v167_state_conditioned_motion_moviebench16" / "full8"
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=run_root / "analysis" / "v167_corrected_metrics.json",
    )
...
def main() -> None:
    ...
    report = {
        ...
        "dynamic_win_tie_loss": {
            ...
            STATE_RANK: dynamic_win_tie_loss(raw, reference=STATE_RANK),
