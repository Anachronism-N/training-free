...
COMPARISON_MANIFEST="$ROOT/runs/v187_hybrid_retrieval/vbench_comparison/comparison_manifest.json"
VIDEOS_PATH="$ROOT/runs/v187_hybrid_retrieval/vbench_comparison/published/$METHOD"
FULL_JSON_DIR="$VBENCH_ROOT/vbench2_beta_long/VBench_full_info.json"
OUTPUT_BASE="$ROOT/runs/v187_hybrid_retrieval/metrics/vbench_long_parts/$METHOD"
