#!/bin/bash
# Usage: bash run_v190_method.sh <method_name>
...
METHODS="$1" NODE_RANK=0 NUM_NODES=1 GPU_LIST=0,1,2,3,4,5,6,7 RUN_UNIT_TESTS=0 bash scripts/run_v190_head_phase_causal_screen_32gpu.sh generate32
echo "method $1 done: $?"
