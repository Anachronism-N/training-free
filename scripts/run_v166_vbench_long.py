#!/usr/bin/env python3
"""Run prompt-correct VBench-Long core-9 for v166."""
...
def analyze(payload: dict) -> dict:
    ...
    for method in METHODS:
        ...
        if set(row) != set(DIMENSIONS):
            raise ValueError(f"{method}: incomplete v166 VBench dimensions")
        if abs(
    ...
    return {
        ...
        "claim_boundary": (
            ...
            "v166 corrected analysis; these 16 prompts remain development "
...
def configure_base() -> None:
    ...
    base.ANALYSIS_STEM = "v166_vbench_analysis"
    base.SUMMARY_TITLE = "v166 Multi-scale Motion VBench-Long Core-9"
