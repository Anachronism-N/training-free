#!/usr/bin/env python3
"""Run the v163 strict state-matched coherent-motion retrieval experiment."""
...
EXPERIMENT = "v163_statemotion_strict"
PROMPT_COUNT = 16
...
V163_CELLS = (
    Cell(
        "v163_middle10_reservoir2_statemotion1_strict",
        "v163_statemotion_strict",
        "single",
        support_policy="reservoir2_statemotion1_strict",
    ...
    Cell(
        "v163_middle10_reservoir2_motionpair1_reference",
        "v163_reference",
        "single",
...
def configure_parent_runner() -> None:
    ...
    runner.DEFAULT_CANDIDATES = (
        "middle10_reservoir2_statemotion1_strict",
...
def load_v161_source(prompt_manifest: dict, *, pf_runtime: dict) -> dict:
    ...
    skip_wave1 = os.environ.get("V163_SKIP_V161_WAVE1", "") == "1"
    for path in (
        published_path,
        contract_path,
        trace_path,
    ...
    contract.update(
        {
            ...
            "design": {
                ...
                "isolated_change_from_v161": (
                    "tighter state-matching thresholds (state>=0.0, "
                    "direction>=0.1)"
                ),
                "fixed_factors": (
            ...
            "claim_boundary": (
                "v163 is a failure-focused exploratory recovery experiment. "
