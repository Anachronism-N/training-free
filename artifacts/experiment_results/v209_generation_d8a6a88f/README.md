# v209 native Self-Forcing Screen32 rerun

- Source commit: `d8a6a88fa866df60dd1b8c2c5d4aca8cc9c01adf`
- Output root: `/apdcephfs_gy2/share_302533218/cedricnie/v209_runs/v209_d8a6a88f_sixnode`
...
This compact package contains the frozen manifest/configs/prompts, formal launch and repair provenance, comparison and split manifests, VBench summaries, temporal diagnostics and contract, paired budget analyses, completion receipt, and small audits. MP4 files, split clips, models, checkpoints, raw VBench parts, traces, and tensor dumps are excluded.
