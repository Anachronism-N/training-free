...
Status: 30s_60s_diagnostics_available
...
| v220 | ours_correct - sf_fifo21 | +0.2290 | -0.3646 | +0.1436 | +0.1696 | 27/64 |
...
| Observed DD change | Prompts | Mean imaging delta | Contribution to full imaging delta |
|---|---:|---:|---:|
| dd_down | 14 | +0.8515 | +0.1863 |
| dd_tied | 27 | -0.3463 | -0.1461 |
| dd_up | 23 | +0.5255 | +0.1889 |
- Top 1 positive prompts: sources [113], 10.7% of positive-delta mass. They are NOT removed from the main estimate.
- Top 3 positive prompts: sources [113, 89, 101], 27.8% of positive-delta mass. They are NOT removed from the main estimate.
